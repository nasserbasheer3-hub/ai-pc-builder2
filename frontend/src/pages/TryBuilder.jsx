            ...
            <Card tilt>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 7 }}>
                {CATS.map(([key, label]) => {
                  ...
                  if (!p) return null;
                  return (
                    <div key={key} style={{ padding: '9px 12px', background: 'rgba(0,0,0,0.25)', borderRadius: 12, border: '1px solid var(--border)' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', gap: 10 }}>
                        ...
                        <div style={{ whiteSpace: 'nowrap', fontWeight: 700, color: 'var(--primary-2)' }}>{p.price.toLocaleString()} {result.currency}</div>
                      </div>
